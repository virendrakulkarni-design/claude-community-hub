...
function startDwellTracker() {
  ...
  if (postImpressionLogged[postId]) {
    // Already logged for this dispatch in this session; keep current badge displayed
    return;
  }
...
function onDwellThresholdReached(postId) {
  ...
  const baseEndpoint = 'https://hits.sh/virendrakulkarni-design.github.io/claude-community-hub-impressions.svg?label=Impressions&color=da7756';
  ...
  try {
    const totalKey = 'claude_hub_total_impressions';
